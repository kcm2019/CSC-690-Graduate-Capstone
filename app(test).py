...
# Flag to indicate whether Flask has initialized
...
def create_llms_model():
    start_time = time.time()
    llm = CTransformers(model="/home/kurtmuller/Documents/Projects/AIJobInterviewPrepBot-master/mistral-7b-instruct-v0.1.Q4_K_M.gguf", config={'max_new_tokens': 500, 'temperature': 0.01})
...
def index():
    ...
    if request.method == 'POST':
        ...
        if not flask_initialized:
            # Call setup_model function if Flask is not yet initialized
            setup_model()
